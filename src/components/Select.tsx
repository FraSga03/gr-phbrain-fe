    ...
    return (
        <div className="flex flex-col">
            <select
                ...
                onChange={onChange ? (e) => onChange(e.target.value) : registration?.onChange}
                className={`${className} bg-white shadow-sm rounded-[4px] px-3 border border-gray-200 outline-none transition
